...
ROOT = component.ROOT
PARENT_MANIFEST = (
    ROOT / "docs/vq2_vg035_parent_count11_manifest_2026-07-31.json"
)
CANDIDATE_MANIFEST = (
    ROOT / "docs/vq2_vg035_candidate_count11_manifest_2026-07-31.json"
)
RUNNER = ROOT / "scripts/run_vq2_vg035_vast.sh"


def test_vg035_manifests_bind_same_fresh_count11_fixture() -> None:
    ...
    assert parent["seed"] == 429134
    assert parent["agents"] == parent["episodes"] == 32
    assert parent["num_threads"] == 4
    assert parent["max_steps"] == 2560


def test_vg035_runner_is_parallel_resumable_source_locked_and_offline() -> None:
    ...
    assert "tests/test_vq2_vg035_staged_count11_diagnostic.py" in text
