...
from scripts.collect_vq2_measured_two_gate_dagger_phase1_second import (
...
def test_sf062_retains_well_formed_failure_terminals() -> None:
    configure_iteration()
    assert iteration.COLLECTION_STEP_LIMIT == COLLECTION_STEP_LIMIT == 1600
    assert iteration.SEED == 42062
