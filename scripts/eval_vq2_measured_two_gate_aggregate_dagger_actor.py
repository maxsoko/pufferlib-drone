#!/usr/bin/env python3
"""Run SF067 for the aggregate current-distribution DAgger checkpoint."""
...
PREREGISTRATION = ROOT / "docs/vq2_sf067_measured_two_gate_teacher_free_preregistration_2026-07-28.md"
CHECKPOINT = (
    ROOT
...
def run_screen(*, output: Path = DEFAULT_OUTPUT, device_name: str = "cuda") -> dict:
    ...
    report["screen_parent_tag"] = "vq2_sf066_aggregate_dagger_fit_001"
