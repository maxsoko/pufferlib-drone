...
.venv/bin/python scripts/eval_vq2_lc234_phase2_sequence_numpy_batch1.py --target 3
...
PY
then
    .venv/bin/python scripts/eval_vq2_lc234_phase2_sequence_numpy_batch1.py --target 24
fi
