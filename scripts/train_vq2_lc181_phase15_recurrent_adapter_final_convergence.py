#!/usr/bin/env python3
"""Final bounded convergence of the early-weighted phase-15 adapter."""
...
TAG = "vq2_lc181_phase15_recurrent_adapter_final_convergence_001"
SCHEMA = "vq2_lc181_phase15_recurrent_adapter_final_convergence_report_v1"
CHECKPOINT_SCHEMA = "vq2_lc181_phase15_recurrent_adapter_final_convergence_checkpoint_v1"
EPOCHS = 300
LEARNING_RATE = 1e-3
MINIMUM_VALIDATION_IMPROVEMENT = 4.0
MAXIMUM_VALIDATION_MSE = 4e-5
...
PARENT_DIR = ROOT / "logs/drone_race_full_policy_six_gate_bootstrap/vq2_lc180_phase15_recurrent_adapter_early_weighted_001"
PARENT_CHECKPOINT = PARENT_DIR / "policy_selected.pt"
PARENT_CHECKPOINT_SHA256 = "479bd7d2d61cb70b5f0329aa0f09cade3f1fac6dc67d8bca39c71335f196fae1"
PARENT_REPORT = PARENT_DIR / "report.json"
PARENT_REPORT_SHA256 = "25ef3d41f4d96dcbfc8cb699e2735fd9dc17e55792d07554c80ebda3d3e52891"
...
PREREGISTRATION = ROOT / "docs/vq2_lc181_phase15_recurrent_adapter_final_convergence_preregistration_2026-08-01.md"
RUNNER = ROOT / "scripts/run_vq2_lc181_vast.sh"
TEST = ROOT / "tests/test_train_vq2_lc181_phase15_recurrent_adapter_final_convergence.py"
DEFAULT_OUTPUT = ROOT / "logs/drone_race_full_policy_six_gate_bootstrap" / TAG
NEXT_AUTHORITY_ADMITTED = (
    "Run one teacher-free LC176-versus-LC181 raw-16 screen; no FlightSim authority."
)
NEXT_AUTHORITY_REJECTED = (
    "Reject the offline adapter-convergence family and collect adapter-owned on-policy sequences; do not run FlightSim."
)
...
def verify_inputs() -> dict[str, Any]:
    for path, digest in {
        ...
        if sha256_path(path) != digest:
            raise RuntimeError(f"LC181 bound input changed: {path}")
    ...
    if (
        parent.get("schema") != "vq2_lc180_phase15_recurrent_adapter_early_weighted_checkpoint_v1"
        ...
        or parent_report.get("schema") != "vq2_lc180_phase15_recurrent_adapter_early_weighted_report_v1"
        ...
        or parent_report.get("best_epoch") != 100
        or parent_report.get("validation_improvement_factor") != 2.4435844712804444
        or parent_report.get("best_validation_teacher_action_mse") != 0.0001417257881257683
        or len(history) != 100
        ...
        raise RuntimeError("LC178/LC180 do not authorize LC181")
    return parent
...
def configure() -> tuple[Any, ...]:
    originals = (
        ...
        prior.MAXIMUM_VALIDATION_MSE, prior.TEMPORAL_WEIGHT_SEGMENTS,
