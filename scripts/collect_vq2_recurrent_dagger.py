#!/usr/bin/env python3
"""Collect legal SF014-visited states with SF009 oracle query labels."""
...
def collect(
    ...
    *,
    ...
    if device_name == "cuda" and not torch.cuda.is_available():
        raise RuntimeError("SF017 preregisters CUDA inference")
    ...
    if vector.total_agents != AGENTS or vector.obs_size != ENV_OBS_SIZE:
        vector.close()
        raise RuntimeError("native vector ABI differs from SF017")
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(
            ...
            if not admitted:
                raise RuntimeError(
                    "SF017 collection failed admission; permanent labels were not written"
                )
    ...
    source_paths = [
        ...
        ROOT / "docs/vq2_sf017_recurrent_dagger_preregistration_2026-07-28.md",
        CHECKPOINT,
        SF016_REPORT,
    ]
    source_hashes = {
