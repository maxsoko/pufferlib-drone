#!/usr/bin/env python3
"""Collect oracle labels on SF059's exact-course visited states."""
...
PREREGISTRATION = (
    ROOT
    / "docs/vq2_sf062_measured_two_gate_dagger_preregistration_2026-07-28.md"
)
CHECKPOINT = (
    ROOT
...
SCREEN_REPORT = (
    ROOT
    / "logs/drone_race_full_policy_six_gate_bootstrap"
    / "vq2_sf060_measured_two_gate_teacher_free_512/report.json"
)
...
def collect(output: Path = DEFAULT_OUTPUT, *, device_name: str = "cuda") -> dict:
    ...
    metadata["action"]["plant_action_source"] = "sf059_phase_actor_mean"
