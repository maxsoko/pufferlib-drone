#!/usr/bin/env python3
"""Fit only phase 6 on LC040 from the LC043 parent."""
...
TAG = "vq2_lc044_phase6_student_head_001"
SCHEMA = "vq2_lc044_phase6_student_head_report_v1"
STATE_SCHEMA = "vq2_lc044_phase6_student_head_state_v1"
CHECKPOINT_SCHEMA = "vq2_lc044_phase6_student_head_checkpoint_v1"
TARGET_PHASES = (6,)
LC043 = (
...
PREREGISTRATION = (
    ROOT / "docs/vq2_lc044_phase6_student_head_preregistration_2026-07-31.md"
)
RUNNER = ROOT / "scripts/run_vq2_lc044_vast.sh"
DEFAULT_OUTPUT = (
    ROOT / "logs/drone_race_full_policy_six_gate_bootstrap" / TAG
)
CONFIG = dataclasses.replace(base.CONFIG, seed=431440, chunk_rows=131_072)
...
def verify_inputs() -> dict[str, Any]:
    ...
    for path, digest in expected.items():
        if sha256_path(path) != digest:
            raise RuntimeError(f"LC044 bound input changed: {path}")
    ...
    if (
        ...
        raise RuntimeError("LC040/LC041/LC043 do not authorize phase-6 isolation")
    return report
