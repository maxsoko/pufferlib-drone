#!/usr/bin/env python3
"""Continue LC176's phase-15 recurrent adapter to near-zero sequence error."""
...
TAG = "vq2_lc179_phase15_recurrent_adapter_convergence_001"
SCHEMA = "vq2_lc179_phase15_recurrent_adapter_convergence_report_v1"
CHECKPOINT_SCHEMA = "vq2_lc179_phase15_recurrent_adapter_convergence_checkpoint_v1"
EPOCHS = 80
LEARNING_RATE = 5e-4
...
PREREGISTRATION = ROOT / "docs/vq2_lc179_phase15_recurrent_adapter_convergence_preregistration_2026-08-01.md"
RUNNER = ROOT / "scripts/run_vq2_lc179_vast.sh"
TEST = ROOT / "tests/test_train_vq2_lc179_phase15_recurrent_adapter_convergence.py"
DEFAULT_OUTPUT = ROOT / "logs/drone_race_full_policy_six_gate_bootstrap" / TAG
NEXT_AUTHORITY_ADMITTED = (
    "Run one teacher-free LC176-versus-LC179 raw-16 screen; no FlightSim authority."
)
NEXT_AUTHORITY_REJECTED = "Reject LC179; do not screen or run FlightSim."
...
def verify_inputs() -> dict[str, Any]:
    for path, digest in {
        ...
        if sha256_path(path) != digest:
            raise RuntimeError(f"LC179 bound input changed: {path}")
    ...
    if (
        ...
        or parent_report.get("validation_improvement_factor", 0.0) < 96.4
        ...
        raise RuntimeError("LC176/LC178 do not authorize LC179")
    return parent
