#!/usr/bin/env python3
"""Run SF060 for the phase-1 DAgger checkpoint."""
...
PREREGISTRATION = (
    ROOT
    / "docs/vq2_sf060_measured_two_gate_teacher_free_preregistration_2026-07-28.md"
)
CHECKPOINT = (
    ROOT
...
def run_screen(*, output: Path = DEFAULT_OUTPUT, device_name: str = "cuda") -> dict:
    ...
    report["screen_parent_tag"] = "vq2_sf059_measured_two_gate_dagger_fit_001"
