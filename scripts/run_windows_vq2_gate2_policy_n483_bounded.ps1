param(
    [string]$Tag = "vq2_n483_fixed_state_gate2_bounded_003",
    [ValidateRange(12, 14)]
...
Assert-SHA256 $CallablePath "1df2a68feac5e4b3f0c3ed3a25992114d6e6c95e28f4acb33a0cb453257b4ba2"
...
if (Test-Path $JsonPath) {
    throw "refusing to overwrite existing N483 evidence: $JsonPath"
}
...
$env:PUFFER_POLICY_GATE2_INITIAL_GATE_POSITION_WORLD_X = "14.673019876038335"
$env:PUFFER_POLICY_GATE2_INITIAL_GATE_POSITION_WORLD_Y = "8.466995811979634"
$env:PUFFER_POLICY_GATE2_INITIAL_GATE_POSITION_WORLD_Z = "2.404214417922695"
...
if ($LASTEXITCODE -ne 0) {
    ...
    throw "N483 fixed-state bounded attempt failed"
}
...
if (-not $Report.acceptance_passed -or
    ...
    throw "N483 did not prove a clean Gate-2 completion"
}
if (-not [bool]$Report.control_inputs.official_reset_start.reset_sent -or
    ...
    throw "N483 lacks detected reset proof"
}
if ([int]$Report.sitl.commands_sent -le 0 -or
    ...
    throw "N483 command transport is invalid"
}
if ([int]$Report.control_inputs.disarm_commands_sent -ne 1) {
    throw "N483 lacks exactly one exit disarm"
}
